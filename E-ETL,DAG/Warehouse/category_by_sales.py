...
class category_by_sales(etl_base):
    ...
    def __init__(self):
        ...
        self.partitionList = ["cre_dtm", "seller_id", "first_category_id", "second_category_id", "third_category_id"]
    ...
    def process(self, df: DataFrame) -> DataFrame:
        ...
        df = df.withColumn("cre_dtm", F.to_timestamp("cre_dtm", "yyyy-MM-dd"))
        ...
        response_schema = T.StructType([
            ...
            T.StructField("orderDetailList", T.ArrayType(T.StructType([
                ...
                T.StructField("firstCategoryId", T.IntegerType()),
                T.StructField("secondCategoryId", T.IntegerType()),
                T.StructField("thirdCategoryId", T.IntegerType()),
        ...
        try:
            ...
            df = df.select(
                ...
                F.col("orderDetails.firstCategoryId").alias("first_category_id"),
                F.col("orderDetails.secondCategoryId").alias("second_category_id"),
                F.col("orderDetails.thirdCategoryId").alias("third_category_id"),
                F.col("orderDetails.categoryName").alias("category_name"),
                F.col("orderDetails.count").cast("integer").alias("total_sales"),
                F.col("orderDetails.totalPrice").cast("integer").alias("total_revenue"),
    ...
    def write(self, df: DataFrame) -> None:
        ...
        try:
            ...
            # JdbcBuilder 인스턴스를 통해 to_print 호출
