...
class highest_number_of_views(etl_base):
    ...
    def read(self) -> DataFrame:
        ...
        try:
            ...
            SELECT  *,
                    get_json_object(response, '$.id') as product_id,
                    get_json_object(response, '$.name') as product_name
    ...
    def process(self, df: DataFrame) -> DataFrame:
        ...
        try:
            ...
            df = (
                df
                .groupBy("product_id", "product_name", "cre_dtm", "etl_dtm",)
                .count()
